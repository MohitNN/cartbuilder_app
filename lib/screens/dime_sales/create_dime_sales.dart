...
import 'package:mint_bird_app/screens/dime_sales/API/create_dimesales_service.dart';
...
Widget createDimeSales(BuildContext contextDownSell) {
            ...
            child: Padding(
              ...
              child: ListView(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 15.0, bottom: 28.0),
                    child: SecondTextField(
                      controller: nameController,
                      hintText: "Enter dime sale name",
                      enabled: true,
                      obscureText: false,
                      validator: (val) {
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      iconSize: 32,
                      items: List.generate(
                          productController.dimeSalesGroup.length, (index) {
                        return DropdownMenuItem(
                          child: Padding(
                            padding: EdgeInsets.only(left: 8),
                            child: Text(
                              productController.dimeSalesGroup[index]["name"]
                                  .toString(),
                              style: TextStyle(
                                fontSize: 14,
                                color: mIconColor,
                          ...
                          value: productController.dimeSalesGroup[index]["id"]
                              .toString(),
                        );
                      }),
                      onChanged: (value) {
                        productController.selectedDimeSaleGroup.value = value;
                      },
                      isExpanded: false,
                      value: productController.selectedDimeSaleGroup.value
                          .toString(),
                      isDense: true,
                    ),
                  ),
