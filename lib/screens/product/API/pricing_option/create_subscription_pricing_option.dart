...
Future<bool> createUpdateSubscriptionPricingOptionService(
  ...
  var response = await http.post(
    Uri.parse(APIUtils.baseUrl +
        ((createUpdate == 'Edit')
            ? APIUtils.updateSubscriptionPricingOption
            : APIUtils.createSubscriptionPricingOption)),
    headers: {
    ...
    body: {
      ...
      "billing_frequency_price":
          paymentOptionsController.monthlyProductPrice.value,
      "todays_price": paymentOptionsController.todayProductPrice.value,
