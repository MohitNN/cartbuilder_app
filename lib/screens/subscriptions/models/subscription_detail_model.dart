...
//
//     final SubscriptionsDetailListDataModel = SubscriptionsDetailListDataModelFromJson(jsonString);

import 'dart:convert';

SubscriptionsDetailListDataModel subscriptionsDetailListDataModelFromJson(
        String str) =>
    SubscriptionsDetailListDataModel.fromJson(json.decode(str));

String subscriptionsDetailListDataModelToJson(
        SubscriptionsDetailListDataModel data) =>
    json.encode(data.toJson());

class SubscriptionsDetailListDataModel {
  SubscriptionsDetailListDataModel({
    this.status,
    this.data,
    this.code,
  });
  ...
  factory SubscriptionsDetailListDataModel.fromJson(
