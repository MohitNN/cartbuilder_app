...
import 'package:mint_bird_app/screens/reporting/API/update_status_service.dart';
...
class _TransactionDetailsState extends State<TransactionDetails> {
              ...
              children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<String>(
                                    value: reportingController
                                        .tsStatus.value,
                                    onChanged: (value) {
                                      reportingController.tsStatus.value =
                                          value;
                                      updateStatusService();
                                    },
                                    underline: SizedBox(),
                ...
                Obx(() {
                  return ListView.builder(
                      ...
                      itemCount: reportingController
                          .transactionDetails.value.data.products.length,
                      itemBuilder: (context, index) {
                        return transactionCard(reportingController
                            .transactionDetails
                            .value
                            .data
                            .products[index]);
  ...
  Widget transactionCard(Product data) {
    return InkWell(
      onTap: () {
