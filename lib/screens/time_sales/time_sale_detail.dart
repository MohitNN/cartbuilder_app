...
import 'package:mint_bird_app/screens/time_sales/API/update_time_sale.dart';
...
class TimeSaleDetails extends StatefulWidget {
  final String title;

  const TimeSaleDetails({Key key, this.title}) : super(key: key);

  @override
  _TimeSaleDetailsState createState() => _TimeSaleDetailsState();
}

class _TimeSaleDetailsState extends State<TimeSaleDetails> {
          ...
          return timeSellController.isLoading.value
              ...
              : Stack(
                  children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  CupertinoSwitch(
                                      value: timeSellController.isActive.value,
                                      onChanged: (value) {
                            ...
                            timeSellController.autoManual.value == 0
                                ...
                                : Column(
                                    ...
                                    children: [
                                      timeSellController.manualList.length == 0
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            colorContainer(
                                                timeSellController.topBarColor)
                                          ],
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            colorContainer(
                                                timeSellController.buttonColor)
                                          ],
                                        ),
                                      ),
                                    ),
                            ...
                            GestureDetector(
                              onTap: () {
                                Map<String, dynamic> body = {
                                  "_id":
                                      "${timeSellController.timeSellDetail.value.id}",
                                  "sales": [
                                    {
                                      "active":
                                          timeSellController.isActive.value,
                                ...
                                if (timeSellController.autoManual.value == 1) {
                    ...
                    timeSellController.isConfigured.value
                        ? SizedBox()
                        : BackdropFilter(
